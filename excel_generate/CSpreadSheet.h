...
{
public:
	CTable(int attributes, int metrics):m_attrs(attributes),m_metrics(metrics){}
...
class CSpreadSheet : public CFileGenFactory
{
public:
	...
	bool AddHeaders(CStringArray &FieldNames, std::vector<int>* pDatatype  = NULL, bool replace = false); // Add header row to spreadsheet
